"""
HOLC Redlining and Income/Wages Correlation Analysis – Los Angeles, California
===============================================================================
This script analyzes the correlation between 1930s HOLC redlining grades
in Los Angeles and current income levels by census tract.
...
# California FIPS = 06; Los Angeles County = 037
STATE_FIPS = "06"
LA_COUNTIES = ["037"]
...
def download_holc_data():
    ...
    if not os.path.exists(cache_path):
        ...
        for url in urls:
            ...
            raise RuntimeError(
                "Could not download Los Angeles HOLC data.\n"
...
print(f"  {len(tracts)} census tracts in Los Angeles County")
...
print("\n" + "=" * 70)
print("  STATISTICAL RESULTS — HOLC Grade vs Income / Wages (Los Angeles)")
print("=" * 70)
...
ax1.set_title(
    f"HOLC Redlining vs Per Capita Income in Los Angeles\nr={r:.3f}, p={p:.4f}",
    fontsize=13,
    fontweight="bold",
)
...
ax2.set_title(
    "Income Distribution by Dominant HOLC Grade – Los Angeles",
    fontsize=13,
    fontweight="bold",
)
...
ax3.set_title(
    f"HOLC Redlining vs Poverty Rate in Los Angeles\nr={r3:.3f}, p={p3:.6f}",
    fontsize=13,
    fontweight="bold",
)
...
ax4.set_axis_off()
ax4.set_title(
    "Per Capita Income Map with HOLC Zone Boundaries – Los Angeles",
    fontsize=13,
    fontweight="bold",
)
