"""
HOLC Redlining and Life Expectancy Correlation Analysis – Los Angeles, California
=================================================================================
This script analyzes the correlation between 1930s HOLC redlining grades
in Los Angeles and current life expectancy by census tract.
...
def download_life_expectancy():
    ...
    """
    print("  Querying CDC USALEEP data for California (Los Angeles County)...")
...
print("\n" + "=" * 65)
print("  STATISTICAL RESULTS — HOLC Grade vs Life Expectancy (Los Angeles)")
print("=" * 65)
...
ax1.set_title(
    f"HOLC Score vs Life Expectancy in Los Angeles\nr={r:.3f}, p={p:.4f}",
    fontsize=13,
    fontweight="bold",
)
...
ax2.set_title(
    "Life Expectancy by Dominant HOLC Grade – Los Angeles",
    fontsize=13,
    fontweight="bold",
)
...
ax3.set_title(
    f"Redlined Fraction vs Life Expectancy in Los Angeles\nr={r2:.3f}, p={p2:.4f}",
    fontsize=13,
    fontweight="bold",
)
...
ax4.set_axis_off()
ax4.set_title(
    "Life Expectancy Map with HOLC Zone Boundaries – Los Angeles",
    fontsize=13,
    fontweight="bold",
)
