"""
HOLC Redlining Map – Los Angeles, California
=============================================
This script downloads and visualizes the 1930s HOLC redlining map for Los Angeles.
...
if not os.path.exists(geojson_path):
    print("Downloading Los Angeles HOLC redlining data from Mapping Inequality...")
    holc_urls = [
    ...
    if not downloaded:
        print("ERROR: Could not download Los Angeles HOLC data.")
...
# Set plot title
ax.set_title('HOLC Redlining Grades in Los Angeles', fontdict={'fontsize': '20', 'fontweight': '3'})
